...
/**
 * Chat page migrated into the shell feature tree.
 *
 * Behaviors preserved verbatim from the Next.js page:
 * - SSE chat via useChat hook
 * - Lazy loading of DbEditor / ChatContainer for chat_dashboard scene
...
const ChatPage: React.FC = () => {
  ...
  const contentRender = () => {
    if (scene === 'chat_dashboard') {
      return (
        <Suspense fallback={<Spin className='h-full w-full' />}>
